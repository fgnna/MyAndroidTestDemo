...
Java_someday_com_ndk_MainActivity_initSystemNativeHook(JNIEnv *env, jclass type) {
    LOGD("Build system hook info init");
...
void JNICALL
Java_someday_com_ndk_MainActivity_initCustomNativeHook(JNIEnv *env, jclass type, jstring lib_name) {
